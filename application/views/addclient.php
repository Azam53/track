          ...
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Client</h3>
          		 ...
          		 <div class="row mt"><!-- row start-->
      				...
      				<! -- BUTTONS ROUND -->
      				<div class="showback" >
      					<h4><i class="fa fa-angle-right"></i> Add Client </h4>
						<!--<button type="file" class="btn btn-round btn-default">Browse</button>-->
                                                <form id="client_form" action="<?php echo base_url ('index.php/resource/insert_client'); ?>" method="post" enctype="multipart/form-data">
