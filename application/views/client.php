     ...
     <!--main content start-->
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Client's List</h3>
          		 ...
          		 <div class="row mt"><!-- row start-->
      				...
      				<! -- BUTTONS ROUND -->
      				<div class="showback" >
      					<h4><i class="fa fa-angle-right"></i>  Client's Details </h4>
       ...
       <?php
               ...
               echo      '                           <td>'.$value['id'].'</td>
                                                     <td>'.$value['name'].'</td>  
                                                     <td><button class="btn btn-danger btn-xs" title="delete" onclick="ask_to_delete_client('.$value['id'].')"><i class="fa fa-trash-o "></i></button></td>
                                                   </tr>
                         ';
                                  }
        ?>
