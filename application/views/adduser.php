...
?>
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="main.php" class="logo"><b>Real Estate Admin</b></a>
            <!--logo end-->
       ...
       <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="#"><img src="assets/img/dummy.png" class="img-circle" width="60"></a></p>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="property.php">Property List</a></li>   
                      </ul>
                  </li>
          ...
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Add User</h3>
          		 ...
          		 <div class="row mt"><!-- row start-->
      				...
      				<! -- BUTTONS ROUND -->
      				<div class="showback" >
      					<h4><i class="fa fa-angle-right"></i> Add Team Member</h4>
						<!--<button type="file" class="btn btn-round btn-default">Browse</button>-->
                                                <form action="requesthandler.php" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
                                               ...
                                               <!-- <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="banner_headline" name="email">
                                                </div>-->
