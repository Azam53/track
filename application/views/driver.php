     ...
     <!--main content start-->
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Driver's</h3>
          		 ...
          		 <div class="row mt"><!-- row start-->
      				...
      				<! -- BUTTONS ROUND -->
      				<div class="showback" >
      					<h4><i class="fa fa-angle-right"></i> Add Driver </h4>
						<!--<button type="file" class="btn btn-round btn-default">Browse</button>-->
                                                <form id="client_form" action="<?php echo base_url ('index.php/resource/insert_driver'); ?>" method="post" enctype="multipart/form-data">
